...
def exit(): #Exit function
    ...
    print("\t\t   <->  ")
    print()
    print("You can download the files from the link\nhttps://github.com/amanvir-singh/LearningPython\n\tOr\nhttps://replit.com/@amanvirsingh880/Learning-Python-from-Python")
    time.sleep(2.8)
...
def web():
    ...
    print()
    if ch==1:
        print('https://github.com/amanvir-singh/LearningPython')
        ...
        ch1=input('-> ')
        if ch1=='9':
            webbrowser.open_new('https://github.com/amanvir-singh/LearningPython')
            time.sleep(3.1)
        ...
        print('https://replit.com/@amanvirsingh880/Learning-Python-from-Python')
        print('\nThis is the Repl link, either copy it and then paste in your browser,\nOr enter 9 to open the link directly in your browser.\nPress any other key to go back to menu.')
        ch1=input('-> ')
        if ch1=='9':
            webbrowser.open_new('https://replit.com/@amanvirsingh880/Learning-Python-from-Python')
            time.sleep(3.1)
            input('To continue back, press enter key.')
            menu()
            return
...
def welcome():
    ...
    print('\n')
    time.sleep(1.5)
    print("This software is developed by 'Amanvir Singh', 'Jasmeet Kaur' & 'Manvir Kaur'\n")
    time.sleep(0.9)
    q=0
    while q<29:
      print('-~',end='')
...
user_details=''
if username=='adminajm' or username=='computer':#For admin
    user_details='admin'
with open('Login Details.csv','r') as ob:
    data=csv.reader(ob)
    for i in data:
